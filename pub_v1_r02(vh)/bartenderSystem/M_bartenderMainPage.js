...
function checkOutFunc(tmp)
{
    ...
    else if(systemEnvironment.language == "sv")
    {
        ...
        if(tmp == undefined)
            ...
            tomSt += "</table></div ><p id='itemWarn' style='color: red; visibility: hidden;'>Please select item for checkout!</p><p><span class=\"neonButton\"  style=\"margin-top: 0.79vh; width: 11.87vh; float: left;  background-color:\" onclick=\"resetCheckout()\" />återställ & Close</span>";
