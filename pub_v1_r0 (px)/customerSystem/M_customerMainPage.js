...
function checkOutFunc(tmp)
{
    ...
    else if(systemEnvironment.language == "sv")
    {
        ...
        if(tmp == undefined)
            ...
            tomSt += "</table></div ><p id='itemWarn' style='color: red; visibility: hidden;'>Please select item for checkout!</p><p><span class=\"neonButton\"  style=\"margin-top: 5px; width: 75px; float: left;  background-color:\" onclick=\"resetCheckout()\" />Återställ & Stäng</span>";
