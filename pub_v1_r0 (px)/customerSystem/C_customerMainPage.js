...
{ 
    ...
    if(systemEnvironment.language == "en")
        beerPopup.innerHTML = "<br><h1 style='padding: 10px; font-size: 2em; text-align: center;'>Lucky Pick<br><br>" + beers[k] + "</h1>"; 
    else if(systemEnvironment.language == "sv")
        beerPopup.innerHTML = "<br><h1 style='padding: 10px; font-size: 2em; text-align: center;'>Tur Plockning<br><br>" + beers[k] + "</h1>";
